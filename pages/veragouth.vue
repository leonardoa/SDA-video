        ...
        <div id="frame">
            <div class="item item1">
                <video muted id="video1">
                    <source src="~/static/veragouth/veragouth1.mp4" type="video/mp4">
                </video>
            </div>
            <div class="item item2">
                <video muted id="video2">
                    <source src="~/static/veragouth/veragouth2.mp4" type="video/mp4">
                </video>
            </div>
            <div class="item item3">
                <video muted id="video3">
                    <source src="~/static/veragouth/veragouth3.mp4" type="video/mp4">
                </video>
            </div>
            <div class="item item4">
                <video muted id="video4">
                    <source src="~/static/veragouth/veragouth4.mp4" type="video/mp4">
                </video>
            </div>
            <div class="item item5">
                <video muted id="video5">
                    <source src="~/static/veragouth/veragouth5.mp4" type="video/mp4">
                </video>
            </div>
            <div class="item item6">
                <video muted id="video6">
                    <source src="~/static/veragouth/veragouth6.mp4" type="video/mp4">
                </video>
            </div>
...
export default {
    ...
    mounted() {
        ...
        let item1 = document.querySelectorAll('.item1')[0];
        let video1 = document.querySelector('#video1');

        let item2 = document.querySelectorAll('.item2')[0];
        let video2 = document.querySelector('#video2');

        let item3 = document.querySelectorAll('.item3')[0];
