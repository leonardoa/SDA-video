        ...
        <div id="frame">
            <div class="item item1">
                <video muted id="video1">
                    <source src="~/static/salvo/salvatore1.mp4" type="video/mp4">
                </video>
            </div>
            <div class="item item2">
                <video muted id="video2">
                    <source src="~/static/salvo/salvatore2.mp4" type="video/mp4">
                </video>
            </div>
            <div class="item item3">
                <video muted id="video3">
                    <source src="~/static/salvo/salvatore6.mp4" type="video/mp4">
                </video>
            </div>
            <div class="item item4">
                <video muted id="video4">
                    <source src="~/static/salvo/salvatore3.mp4" type="video/mp4">
                </video>
            </div>
            <div class="item item5">
                <video muted id="video5">
                    <source src="~/static/salvo/salvatore4.mp4" type="video/mp4">
                </video>
            </div>
            <div class="item item6">
                <video muted id="video6">
                    <source src="~/static/salvo/salvatore5.mp4" type="video/mp4">
                </video>
            </div>
